...
export default class FFLiMiiDataCore {
	...
	private parse(): void {
		...
		const buffer = this.stream.readBytes(0x48);
	...
	private validateFields(): void {
		...
		assert.ok(Util.inRange(this.region.characterSet, Util.range(4)), `Invalid MiiGen2 character set. Got ${this.region.characterSet}, expected 0-3`);
		...
		assert.ok(this.appearance.sex === 'male' || this.appearance.sex === 'female', `Invalid MiiGen2 sex. Got ${this.appearance.sex}, expected "male" or "female`);
		...
		assert.ok(Util.inRange(this.appearance.width, Util.range(128)), `Invalid MiiGen2 width. Got ${this.appearance.width}, expected 0-127`);
		assert.ok(Util.inRange(this.appearance.height, Util.range(128)), `Invalid MiiGen2 height. Got ${this.appearance.height}, expected 0-127`);
		...
		assert.ok(Util.inRange(this.appearance.eyes.height, Util.range(7)), `Invalid MiiGen2 eye height. Got ${this.appearance.eyes.height}, expected 0-6`);
		...
		assert.ok(Util.inRange(this.appearance.eyebrows.height, Util.range(7)), `Invalid MiiGen2 eyebrow height. Got ${this.appearance.eyebrows.height}, expected 0-6`);
		...
		assert.ok(Util.inRange(this.appearance.mouth.height, Util.range(7)), `Invalid MiiGen2 mouth height. Got ${this.appearance.mouth.height}, expected 0-6`);
		...
		assert.ok(Util.inRange(this.appearance.facialHair.color, Util.range(8)), `Invalid MiiGen2 facial hair color. Got ${this.appearance.facialHair.color}, expected 0-7`);
		...
		assert.ok(Util.inRange(this.appearance.glasses.color, Util.range(6)), `Invalid MiiGen2 glassess color. Got ${this.appearance.glasses.color}, expected 0-5`);
		assert.ok(Util.inRange(this.appearance.glasses.scale, Util.range(8)), `Invalid MiiGen2 glassess scale. Got ${this.appearance.glasses.scale}, expected 0-7`);
